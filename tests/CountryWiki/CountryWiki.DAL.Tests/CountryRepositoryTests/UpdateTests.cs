...
public sealed class UpdateTests : CountryRepositoryTestsBase
{
    ...
    {
        // Arrange
        Client.UpdateAsync(Arg.Any<CountryUpdateRequest>(), Arg.Any<Metadata?>(), Arg.Any<DateTime?>(),
        ...
        // Assert
        _ = Client.Received(1)
            .UpdateAsync(Arg.Is<CountryUpdateRequest>(x => x.Id == model.Id && x.Description == model.Description),
